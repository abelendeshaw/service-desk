                  ...
                  <TableCell className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-muted-foreground">By {article.authorName}</div>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell className="px-5 py-3.5">
            ...
            {filtered.map((article) => (
              ...
              >
                <CardContent className="p-0">
                  <div className="mb-3 flex size-8 items-center justify-center rounded-md bg-violet-100">
                    <BookOpen className="w-3.5 h-3.5 text-violet-700" />
                  </div>

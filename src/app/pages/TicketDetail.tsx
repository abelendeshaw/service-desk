                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      >
                        <span
                          className={`size-1.5 rounded-full ${sc.dotClass}`}
                        />
                        {status}
                      </Badge>
                    </div>
                    ...
                    <div className="mt-2 flex items-center gap-4 text-[12px] text-muted-foreground">
                      ...
                      <div className="flex items-center gap-1 text-red-600">
                        ...
                        {ticket.resolutionDueDate
                          ? `Resolution due ${ticket.resolutionDueDate}`
                          : "No due date"}
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Button
                        variant="link"
                        className="h-auto gap-0.5 p-0 text-[11px]"
                      >
              ...
              <Card className="p-5">
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-[13px] font-medium">
                        FortiGate, Cisco Switch and server access through WiFi
                        issue
                      </div>
                      <Button
                        variant="link"
                        className="mt-2 h-auto gap-1 p-0 text-[12px]"
                      >
                  ...
                  <div className="mt-4 border-t pt-4">
                    ...
                    <div className="text-[13px] text-muted-foreground">
                      All active devices are accessed through only through
                      cables so, now we want to access through WIFI.
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="overflow-hidden p-0">
                <CardHeader className="border-b px-0 pb-0">
                  <Tabs
                    value={activeTab}
                    onValueChange={(v) =>
                      setActiveTab(v as "activity" | "notes")
                    }
                  >
                    <TabsList className="h-auto w-full justify-start rounded-none bg-transparent p-0">
                      <TabsTrigger
                        value="activity"
                        className="mx-[18px] rounded-[6px] border-b-2 border-transparent px-[13px] py-3 text-[12px] capitalize data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none"
                      >
                        activity
                      </TabsTrigger>
                      <TabsTrigger
